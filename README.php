...
*/
define('API_KEY','5120909268:AAGtbZrTI6yrfHy7z8_SblWO6CukEQV6Ei4'); // توكن بوتك
...
$name_admin = "@MSK_IRAQ9"; // معرف المطور
$name_admin1 = "@MSK_X_BOT"; // معرف المطور 2 تكدر تخلي بوتك تواصل
$dev = 5001560634; // ايديك
$dev_s = 5001560634; // ايديك
$New_member = $message->new_chat_member;
$usser = $New_member->username;
$ida = $New_member->id;
$id_bot = '5120909268'; // يدي البوت
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[['text' => "الدعم الفني 📡",'url' => "https://t.me/trxkings5"]],
]
])
]);
}
...
'reply_markup' => json_encode([
'inline_keyboard' => [
[['text' => "الدعم الفني 📡",'url' => "https://t.me/joinchat/MSK_IRAQ9"]],
]
])
  ]);
}
